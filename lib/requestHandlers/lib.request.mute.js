...
module.exports = class Request_Mute extends RequestMediaRenderer
{
    ...
    runAction(_resolve, _reject, _mediaRendererVirtual, _mediaRendererRoom, _roomUdn)
    {
        ...
        {
            _mediaRendererVirtual.setMute(value, this.waitTillConfirmed()).then(function(_data){
                    _resolve(_data);
                }).catch(function(_data){
                    _reject(_data);
                });
        ...
        {
            _mediaRendererRoom.setMute(value, this.waitTillConfirmed()).then(function(_data){
                    _resolve(_data);
                }).catch(function(_data){
                    _reject(_data);
                });
