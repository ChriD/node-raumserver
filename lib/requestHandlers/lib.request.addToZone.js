...
module.exports = class Request_GetZoneConfig extends RequestMediaRenderer
{
    constructor()
    {
        super();
    ...
    runAction(_resolve, _reject, _mediaRendererVirtual, _mediaRendererRoom, _roomUdn)
    {
        ...
        {
            this.managerDisposer.zoneManager.connectRoomToZone(_roomUdn, _mediaRendererZone.udn()).then(function(_data){
                    _resolve(_data);
